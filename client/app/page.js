        ...
        <div className="max-w-5xl mx-auto px-6 py-12 grid grid-cols-2 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <div className="flex flex-col gap-2 text-xs" style={{ color: "var(--mf-ink-3)" }}>
              <a href="/solutions/agencies" className="hover:text-violet-soft transition-colors">{t("sol_agencies")}</a>
              <a href="/solutions/creators" className="hover:text-violet-soft transition-colors">{t("sol_creators")}</a>
              <a href="/solutions/filmmakers" className="hover:text-violet-soft transition-colors">{t("sol_filmmakers")}</a>
              <a href="/solutions/education" className="hover:text-violet-soft transition-colors">{t("sol_education")}</a>
            </div>
          </div>
          ...
          <div>
            ...
            <div className="flex flex-col gap-2 text-xs" style={{ color: "var(--mf-ink-3)" }}>
              <a href="/pricing" className="hover:text-violet-soft transition-colors">{t("footer_pricing")}</a>
              <a href="/dashboard" className="hover:text-violet-soft transition-colors">{t("nav_dashboard")}</a>
              <a href="/login" className="hover:text-violet-soft transition-colors">{t("nav_signin")}</a>
            </div>
          </div>
          ...
          <div>
            ...
            <div className="flex flex-col gap-2 text-xs" style={{ color: "var(--mf-ink-3)" }}>
              <a href="/legal/privacy" className="hover:text-violet-soft transition-colors">{t("footer_privacy")}</a>
              <a href="/legal/terms" className="hover:text-violet-soft transition-colors">{t("footer_terms")}</a>
            </div>
          </div>
        </div>
