...
function LoginForm() {
  ...
  useEffect(() => {
    if (!loading && user) router.replace(localeHref(next));
            ...
            {mode === "signup" && (
              <label className="flex items-start gap-2.5 cursor-pointer">
                ...
                <span className="text-xs leading-relaxed" style={{ color: "var(--mf-ink-2)" }}>
                  ...
                  <a href={localeHref("/legal/terms")} target="_blank" rel="noopener noreferrer" className="underline" style={{ color: "var(--mf-violet-soft)" }}>
                    {t("login_accept_terms")}
                  </a>
                  {" "}{t("login_accept_and")}{" "}
                  <a href={localeHref("/legal/privacy")} target="_blank" rel="noopener noreferrer" className="underline" style={{ color: "var(--mf-violet-soft)" }}>
